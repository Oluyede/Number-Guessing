# Number-Guessing
# Task on create a number guessing game to generate a number between the range of 1 and 2. The game should prompt users for their username.
...
# Link to task: https://replit.com/@oluyedeoluwasey/Number-Guessing#index.js
